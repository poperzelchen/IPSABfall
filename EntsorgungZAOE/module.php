			   ...
			   public function GetTonneB()
    {
        ...
        for ($count = 0; $count < $anzahl; $count++)
        {
            if (strstr($meldung[$count], "SUMMARY:Bioabfall"))
            {
                ...
                $jetzt = date("Ymd") . "\n";
				$jetzt1 = mktime(0, 0, 0, date("Y"),  date("Y"), date("d")-1);
				$jetzt2 = mktime(0, 0, 0, date("Y"),  date("Y"), date("d")-2);
				$jetzt3 = mktime(0, 0, 0, date("Y"),  date("Y"), date("d")-3);
				$jetzt4 = mktime(0, 0, 0, date("Y"),  date("Y"), date("d")-4);
				$jetzt5 = mktime(0, 0, 0, date("Y"),  date("Y"), date("d")-5);
				$jetzt6 = mktime(0, 0, 0, date("Y"),  date("Y"), date("d")-6);
				$jetzt7 = mktime(0, 0, 0, date("Y"),  date("Y"), date("d")-7);
